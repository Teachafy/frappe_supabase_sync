...
class FrappeWebhookHandler:
    ...
    async def process_webhook(self, request: Request, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Failed to process Frappe webhook", error=str(e), payload=payload)
    ...
    async def handle_document_created(self, doctype: str, doc: Dict[str, Any]) -> Dict[str, Any]:
        """Handle document creation event"""
        logger.info("Handling document creation", doctype=doctype, doc_name=doc.get("name"))
    ...
    async def handle_document_updated(self, doctype: str, doc: Dict[str, Any]) -> Dict[str, Any]:
        """Handle document update event"""
        logger.info("Handling document update", doctype=doctype, doc_name=doc.get("name"))
    ...
    async def handle_document_deleted(self, doctype: str, doc_name: str) -> Dict[str, Any]:
