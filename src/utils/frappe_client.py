...
class FrappeClient:
    ...
    async def get_document(self, doctype: str, name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(
                "Failed to get document", doctype=doctype, name=name, error=str(e)
            )
            raise
    ...
    async def delete_document(self, doctype: str, name: str) -> bool:
        ...
        try:
            ...
            logger.error(
                "Failed to delete document", doctype=doctype, name=name, error=str(e)
            )
            raise

    async def search_documents(
        self, doctype: str, search_term: str, fields: Optional[List[str]] = None
    ) -> List[Dict[str, Any]]:
    ...
    async def find_document_by_field(
        self, doctype: str, field: str, value: str
        ...
        try:
            ...
            logger.error(
                "Failed to find document by field",
                doctype=doctype,
                field=field,
                value=value,
                error=str(e),
